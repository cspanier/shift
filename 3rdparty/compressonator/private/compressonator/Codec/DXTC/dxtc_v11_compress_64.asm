...
EXTERN maxerror_init    : std::uint32_t
EXTERN maxerror_epsilon    : std::uint32_t
...
EXTERN expandtable        : std::uint32_t
...
ENDIF
            ...
            pxor mm5, mm5
            punpcklwd mm0, mm5    ; unpack c0/c1 to std::uint32_t's as pcmp is a signed comparison
            punpcklwd mm1, mm5
            movq mm2, mm0
            movq mm3, mm0
            movq mm4, mm0
...
ENDIF
        ...
        ; Final clustering, creating the 2-bit values that define the output
            ...
            next_bit_loop:    ; Do 4 at once
                ...
                mov al, std::uint8_t ptr [rdi+rax+16]
                or al, std::uint8_t ptr [rdi+rbx]
                mov std::uint8_t ptr [rdx], al    ; rdx == block_dxtc+1
