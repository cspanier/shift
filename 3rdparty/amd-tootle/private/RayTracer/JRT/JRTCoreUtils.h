/************************************************************************************/ /**
 ...
 /// \file
 ****************************************************************************************/
#ifndef JRT_CORE_UTILS_H
#define JRT_CORE_UTILS_H
...
// these arrays define which coordinates to select when projecting into a plane
...
TriPlaneState TriPlaneTest(const JRTTriangle& tri, Axis split_component,
                           float split_value);
