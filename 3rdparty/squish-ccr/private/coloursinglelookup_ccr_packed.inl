...
/*schematic view of this structure:
  ...
  union {
    ...
    struct {
      unsigned int cline0 : 8;
      unsigned int cline1 : 8;
      unsigned int error_sqr : 16;
    };

    struct {
      unsigned char cline[2];
      unsigned short error_sqr;
    };
  };
*/
...
#define  SB_ERRSQR(p)    (((p.packed) >> 16))
#define  SB_CLINE0(p)    (((p.packed) >>  0) & 0xFF)
#define  SB_CLINE1(p)    (((p.packed) >>  8) & 0xFF)
