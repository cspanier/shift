#ifndef SHIFT_SERIALIZATION2_UNORDERED_SET_HPP
#define SHIFT_SERIALIZATION2_UNORDERED_SET_HPP
...
compact_output_archive<Order>& operator<<(
  compact_output_archive<Order>& archive, const std::unordered_set<U>& set)
{
