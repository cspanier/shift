...
private:
  ...
  qi::rule<iterator, std::int64_t(), skipper> _sint_const;
  qi::rule<iterator, std::uint64_t(), skipper> _uint_const;
  ...
  qi::rule<iterator, definition_tokens(), skipper> _namescope_body;
