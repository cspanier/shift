...
#include "shift/tools/protogen/generators/proto_generator.hpp"
#include "shift/tools/protogen/generators/cpp_generator.hpp"
#include "shift/tools/protogen/generators/cs_generator.hpp"
#include "shift/tools/protogen/generators/dot_generator.hpp"
...
int translator::run()
{
  ...
  //  _generators["proto"] = std::make_unique<generators::proto_generator>();
  //  _generators["c++"] = std::make_unique<generators::cpp_generator>();
  //  _generators["c#"] = std::make_unique<generators::cs_generator>();
  //  _generators["dot"] = std::make_unique<generators::dot_generator>();
  ...
  //        {
  //          log::error() << "Output path " << output_path << " is no
  //          directory."; return EXIT_FAILURE;
  //        }
  ...
  //              std::back_inserter(file.content));
  //    input_file.close();
  ...
  //  if (!force_rewrite && has_cache_file && input_unchanged &&
  //  output_unchanged)
  //  {
  ...
  //                     << "\", which was passed using the --exclude
  //                     parameter.";
  //        return EXIT_FAILURE;
  //      }
  //    }
