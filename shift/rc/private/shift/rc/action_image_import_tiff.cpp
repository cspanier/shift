...
///// Compresses the source image using AMD Compressonator and store the result
///as
                                       ...
                                       job_description& job) const
{
  ...
  //  /// ToDo: Add support for importing multiple 2D images to cube or 3D
  //  images. if (job.inputs.size() != 1)
  //  {
  ...
  //  if (!fs::exists(input.file->path) ||
  //  !fs::is_regular_file(input.file->path))
  //  {
