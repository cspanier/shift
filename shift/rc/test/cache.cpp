...
BOOST_AUTO_TEST_CASE(rc_cache)
{
  ...
  write_png_image(settings.input_path / "test_image2.png", 32, 32, 0xFF77FF00);
  write_png_image(settings.input_path / "test_image3.png", 32, 32, 0xFFFF0077);
  write_text_file(settings.input_path / ".rc-rules.json", R"({
  "import": {
    "pass": 1,
    "action": "image-import",
    "input": {
