#ifndef PROTOGEN_GENERATOR_CPPGENERATOR_H
#define PROTOGEN_GENERATOR_CPPGENERATOR_H
...
private:
  ...
  ///
  void gather_dependencies(const node& target, const type_reference& reference,
  ...
  ///
  void gather_dependencies(const node& target, const enumeration& enumeration,
                           node_set& required_declarations,
                           node_set& required_definitions, bool definition);
