#ifndef SHIFT_SERIALIZATION_POINTER_HPP
#define SHIFT_SERIALIZATION_POINTER_HPP
...
InputArchive& operator>>(InputArchive& archive, raw_ptr<U>& pointer)
{
...
OutputArchive& operator<<(OutputArchive& archive, const raw_ptr<U> pointer)
{
  auto cache = archive.cache();
  BOOST_ASSERT(cache);
  if (!pointer)
...
///
template <class InputArchive, typename U>
InputArchive& operator>>(InputArchive& archive, std::unique_ptr<U>& pointer)
{
...
OutputArchive& operator<<(OutputArchive& archive,
                          const std::unique_ptr<U>& pointer)
{
  if (pointer)
  {
...
///
template <class InputArchive, typename U>
InputArchive& operator>>(InputArchive& archive, std::shared_ptr<U>& pointer)
{
  auto cache = archive.cache();
  BOOST_ASSERT(cache);
  if (!cache)
...
///
template <class InputArchive, typename U>
InputArchive& operator>>(InputArchive& archive, std::weak_ptr<U>& pointer)
{
  auto cache = archive.cache();
  BOOST_ASSERT(cache);
  if (!cache)
...
///
template <class InputArchive, typename U>
InputArchive& operator>>(InputArchive& archive, core::group_ptr<U>& pointer)
{
  auto cache = archive.cache();
  BOOST_ASSERT(cache);
  if (!cache)
...
template <class OutputArchive, typename U>
OutputArchive& operator<<(OutputArchive& archive,
                          const core::group_ptr<U>& pointer)
{
  auto cache = archive.cache();
  BOOST_ASSERT(cache);
